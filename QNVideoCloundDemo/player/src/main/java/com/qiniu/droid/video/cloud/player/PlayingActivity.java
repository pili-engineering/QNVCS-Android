...
public class PlayingActivity extends AppCompatActivity {
        ...
        public boolean onError(int errorCode) {
            ...
            switch (errorCode) {
                case PLOnErrorListener.ERROR_CODE_IO_ERROR:
                     ...
                     */
                    ToastUtils.s(PlayingActivity.this, getString(R.string.player_playing_io_error));
                    Log.e(TAG, "IO Error!");
                    break;
                case PLOnErrorListener.ERROR_CODE_OPEN_FAILED:
                    ToastUtils.s(PlayingActivity.this, getString(R.string.player_open_failed));
                    break;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.player_activity_playing);
    ...
    public void onClickCopyRoomName(View v) {
        ...
        TSnackbar snackBar = TSnackbar.make(findViewById(R.id.playing_layout),
                String.format(getString(R.string.player_copy_to_clipboard), mRoomName), TSnackbar.LENGTH_SHORT);
        View snackView = snackBar.getView();
        snackView.setBackgroundColor(getResources().getColor(R.color.player_backgroundEndColor));
    ...
    private void updateStatInfo() {
        String logText = String.format(getString(R.string.player_playing_log_text), mBufferingCount, mVideoWidth, mVideoHeight,
