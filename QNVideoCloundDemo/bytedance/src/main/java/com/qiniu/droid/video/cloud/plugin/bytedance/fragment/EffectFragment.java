...
import com.qiniu.droid.video.cloud.plugin.bytedance.adapter.FragmentVPAdapter;
...
import com.qiniu.droid.video.cloud.plugin.bytedance.fragment.contract.presenter.EffectPresenter;
...
import com.qiniu.droid.video.cloud.plugin.bytedance.ui.ProgressBar;

import java.util.ArrayList;
import java.util.List;

import static com.qiniu.droid.video.cloud.plugin.bytedance.fragment.contract.ItemGetContract.MASK;
import static com.qiniu.droid.video.cloud.plugin.bytedance.fragment.contract.ItemGetContract.OFFSET;
import static com.qiniu.droid.video.cloud.plugin.bytedance.fragment.contract.ItemGetContract.TYPE_BEAUTY_BODY;
...
import static com.qiniu.droid.video.cloud.plugin.bytedance.fragment.contract.ItemGetContract.TYPE_FILTER;
...
public class EffectFragment extends BaseFeatureFragment<EffectContract.Presenter, EffectFragment.IEffectCallback> implements OnCloseListener, MakeupOptionFragment.IMakeupOptionCallback, EffectContract.View, ItemGetContract.View, View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_default) {
            onDefaultClick();
        } else if (id == R.id.iv_close_makeup_option) {
            showOrHideMakeupOptionFragment(false);
        }
    }
