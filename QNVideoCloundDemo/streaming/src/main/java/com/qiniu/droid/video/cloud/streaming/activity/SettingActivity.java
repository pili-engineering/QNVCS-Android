...
import static com.qiniu.droid.video.cloud.streaming.utils.StreamingSettings.AUTO_BITRATE_ENABLED;
import static com.qiniu.droid.video.cloud.streaming.utils.StreamingSettings.CODEC_SIZE_PREBUILT_ENABLE;
import static com.qiniu.droid.video.cloud.streaming.utils.StreamingSettings.DEBUG_MODE_ENABLED;
import static com.qiniu.droid.video.cloud.streaming.utils.StreamingSettings.DEFAULT_CACHE;
import static com.qiniu.droid.video.cloud.streaming.utils.StreamingSettings.MAX_CACHE;
import static com.qiniu.droid.video.cloud.streaming.utils.StreamingSettings.PREBUILT_CODEC_SIZE_POS;
import static com.qiniu.droid.video.cloud.streaming.utils.StreamingSettings.PREBUILT_VIDEO_QUALITY_POS;
import static com.qiniu.droid.video.cloud.streaming.utils.StreamingSettings.QUALITY_PRIORITY_ENABLE;
import static com.qiniu.droid.video.cloud.streaming.utils.StreamingSettings.QUIC_ENABLE;
import static com.qiniu.droid.video.cloud.streaming.utils.StreamingSettings.SW_ENABLE;
import static com.qiniu.droid.video.cloud.streaming.utils.StreamingSettings.TARGET_BITRATE;
import static com.qiniu.droid.video.cloud.streaming.utils.StreamingSettings.TARGET_FPS;
import static com.qiniu.droid.video.cloud.streaming.utils.StreamingSettings.TARGET_GOP;
import static com.qiniu.droid.video.cloud.streaming.utils.StreamingSettings.TARGET_HEIGHT;
import static com.qiniu.droid.video.cloud.streaming.utils.StreamingSettings.TARGET_WIDTH;
import static com.qiniu.droid.video.cloud.streaming.utils.StreamingSettings.VIDEO_QUALITY_PREBUILT_ENABLE;
...
public class SettingActivity extends AppCompatActivity {
    ...
    private RadioGroup.OnCheckedChangeListener mOnCheckedChangeListener = new RadioGroup.OnCheckedChangeListener() {
        ...
        public void onCheckedChanged(RadioGroup group, int checkedId) {
            ...
            if (checkedRadioButtonId == R.id.QUIC_protocol) {
                mIsQuicEnable = true;
            } else if (checkedRadioButtonId == R.id.TCP_protocol) {
                mIsQuicEnable = false;
            } else if (checkedRadioButtonId == R.id.codec_sw) {
                mIsSwCodecEnable = true;
            } else if (checkedRadioButtonId == R.id.codec_hw) {
                mIsSwCodecEnable = false;
            } else if (checkedRadioButtonId == R.id.video_quality_prebuilt) {
            ...
            } else if (checkedRadioButtonId == R.id.video_quality_custom) {
            ...
            } else if (checkedRadioButtonId == R.id.codec_size_prebuilt) {
            ...
            } else if (checkedRadioButtonId == R.id.codec_size_custom) {
            ...
            } else if (checkedRadioButtonId == R.id.quality_priority) {
                mIsQualityPriorityEnable = true;
            } else if (checkedRadioButtonId == R.id.bitrate_priority) {
                mIsQualityPriorityEnable = false;
            } else if (checkedRadioButtonId == R.id.enable_auto_bitrate) {
                mIsAutoBitrateEnable = true;
            } else if (checkedRadioButtonId == R.id.disable_auto_bitrate) {
                mIsAutoBitrateEnable = false;
            } else if (checkedRadioButtonId == R.id.enable_debug_mode) {
                mIsDebugModeEnable = true;
            } else if (checkedRadioButtonId == R.id.disable_debug_mode) {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.streaming_activity_setting);
