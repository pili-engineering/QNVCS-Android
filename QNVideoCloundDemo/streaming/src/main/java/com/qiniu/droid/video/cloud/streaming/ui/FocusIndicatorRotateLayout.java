package com.qiniu.droid.video.cloud.streaming.ui;
...
public class FocusIndicatorRotateLayout extends RotateLayout implements FocusIndicator {
    ...
    public void showStart() {
        ...
        if (mState == STATE_IDLE) {
            setDrawable(R.drawable.streaming_ic_focus_focusing);
    ...
    public void showSuccess(boolean timeout) {
        ...
        if (mState == STATE_FOCUSING) {
            setDrawable(R.drawable.streaming_ic_focus_focused);
    ...
    public void showFail(boolean timeout) {
        ...
        if (mState == STATE_FOCUSING) {
            setDrawable(R.drawable.streaming_ic_focus_failed);
            animate().withLayer().setDuration(SCALING_DOWN_TIME).scaleX(1f)
                    .scaleY(1f).withEndAction(timeout ? mEndAction : null);
            mState = STATE_FINISHING;
        }
