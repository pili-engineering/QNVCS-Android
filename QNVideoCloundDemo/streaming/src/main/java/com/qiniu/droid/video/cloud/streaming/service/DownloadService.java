package com.qiniu.droid.video.cloud.streaming.service;
...
import com.qiniu.droid.video.cloud.streaming.model.ProgressEvent;
...
public class DownloadService extends IntentService {
    ...
    private void updateProgress(int progress) {
        mBuilder.setContentText(this.getString(R.string.streaming_android_auto_update_download_progress, progress)).setProgress(100, progress, false);
