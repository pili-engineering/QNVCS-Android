...
public class MergeLayoutConfigView extends FrameLayout {
    ...
    private void init(Context context) {
        ...
        mInit = true;
        View view = LayoutInflater.from(context).inflate(R.layout.rtc_layout_config_view, this, true);
        intView(view);
    }
    ...
    private void intView(View view) {
        ...
        mStretchModeRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.radio_aspect_fill) {
                    mStretchMode = QNStretchMode.ASPECT_FILL;
                } else if (checkedId == R.id.radio_aspect_fit) {
                    mStretchMode = QNStretchMode.ASPECT_FIT;
                } else if (checkedId == R.id.radio_scale_to_fit) {
    ...
    public void setRoomId(String roomId) {
        ...
        String publishUrl = String.format(getResources().getString(R.string.rtc_publish_url), mRoomId);
    ...
    private void setFirstRemoteTrack(UserTrack videoTrack) {
        ...
        if (hasTrack) {
            ...
            if (UserTrackView.TAG_CAMERA.equals(videoTag)) {
                mFirstVideoSwitch.setText(R.string.rtc_video_camera);
            } else if (UserTrackView.TAG_SCREEN.equals(videoTag)) {
                mFirstVideoSwitch.setText(R.string.rtc_video_screen);
            } else {
    ...
    private void setSecondRemoteTrack(UserTrack videoTrack) {
        ...
        if (hasTrack) {
            ...
            if (UserTrackView.TAG_CAMERA.equals(videoTag)) {
                mSecondVideoSwitch.setText(R.string.rtc_video_camera);
            } else if (UserTrackView.TAG_SCREEN.equals(videoTag)) {
                mSecondVideoSwitch.setText(R.string.rtc_video_screen);
            } else {
                if (TextUtils.isEmpty(videoTag)) {
                    mSecondVideoSwitch.setText(R.string.rtc_video_camera);
                } else {
