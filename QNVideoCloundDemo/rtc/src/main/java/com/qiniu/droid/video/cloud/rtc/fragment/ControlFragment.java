package com.qiniu.droid.video.cloud.rtc.fragment;
...
public class ControlFragment extends Fragment {
    ...
    public View onCreateView(
        ...
        mControlView = inflater.inflate(R.layout.rtc_fragment_room, container, false);
        ...
        if (!mIsScreenCaptureEnabled && !mIsAudioOnly) {
            mToggleBeautyButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    mToggleBeautyButton.setImageResource(enabled ? R.mipmap.rtc_face_beauty_open : R.mipmap.rtc_face_beauty_close);
                }
            });
        }
        ...
        mToggleMuteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mToggleMuteButton.setImageResource(enabled ? R.mipmap.rtc_microphone : R.mipmap.rtc_microphone_disable);
            }
        });

        if (mIsScreenCaptureEnabled || mIsAudioOnly) {
            mToggleVideoButton.setImageResource(R.mipmap.rtc_video_close);
        } else {
            mToggleVideoButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    boolean enabled = mCallEvents.onToggleVideo();
                    mToggleVideoButton.setImageResource(enabled ? R.mipmap.rtc_video_open : R.mipmap.rtc_video_close);
                }
            });
        }
        ...
        mToggleSpeakerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mToggleSpeakerButton.setImageResource(enabled ? R.mipmap.rtc_loudspeaker : R.mipmap.rtc_loudspeaker_disable);
            }
        });
