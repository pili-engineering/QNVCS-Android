package com.qiniu.droid.video.cloud.rtc.service;
...
public class DownloadService extends IntentService {
    ...
    private void updateProgress(int progress) {
        mBuilder.setContentText(this.getString(R.string.rtc_android_auto_update_download_progress, progress)).setProgress(100, progress, false);
