...
import com.qiniu.droid.video.cloud.rtc.BuildConfig;
import com.qiniu.droid.video.cloud.rtc.R;
import com.qiniu.droid.video.cloud.rtc.ui.SpinnerPopupWindow;
...
public class SettingActivity extends AppCompatActivity {
    ...
    private RadioGroup.OnCheckedChangeListener mOnCheckedChangeListener = new RadioGroup.OnCheckedChangeListener() {
        ...
        public void onCheckedChanged(RadioGroup group, int checkedId) {
            ...
            } else if (checkedRadioButtonId == R.id.sw_radio_button) {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rtc_activity_setting);
        ...
        mVersionCodeTextView.setText(String.format(getString(R.string.rtc_version_code), getVersionDescription(), getBuildTimeDescription()));
        ...
        String[] configurations = getResources().getStringArray(R.array.rtc_conference_configuration);
        ...
        mAdapter = new ArrayAdapter<String>(this, R.layout.rtc_spinner_item, mDefaultConfiguration);
    }
