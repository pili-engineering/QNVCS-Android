...
public class UserTrackView extends FrameLayout {
    ...
    protected int getLayout() {
        return R.layout.rtc_user_tracks_view;
    }
    ...
    private void updateMicrophoneStateView(boolean isMute) {
        mMicrophoneStateView.setImageResource(isMute ? R.mipmap.rtc_microphone_disable : R.drawable.rtc_microphone_state_enable);
    }
    ...
    private int getTargetColor(int pos) {
        int[] customizedColors = getContext().getResources().getIntArray(R.array.rtc_audioBackgroundColors);
